...
public abstract class DocumentExporter {
	...
	private void dessinerEtape(int noEtape, int nbEtapes, int phraseMin, int phraseMax) {
		...
		currentImagePack.setCommentary(Messages.getInstance().getValue("texte.commentaireetape",
				new Object[] { "" + noEtape }));
	}
	...
	// private void insererImageDansDocument(BufferedImage image, Document document) throws
